...
[![Build Status](https://travis-ci.org/robisys/rust-openssl.svg?branch=master)](https://travis-ci.org/robisys/rust-openssl)

Dokumentation:  [Doc](https://sfackler.github.io/rust-openssl/doc/v0.7.6/openssl).
